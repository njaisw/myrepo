 ...
 * 0 in the input
 */
public class X_IncreasingSubsequnceOfLength3WithMaxProduct {
    ...
    public static void main(String args[]){
        ...
        X_IncreasingSubsequnceOfLength3WithMaxProduct iss = new X_IncreasingSubsequnceOfLength3WithMaxProduct();

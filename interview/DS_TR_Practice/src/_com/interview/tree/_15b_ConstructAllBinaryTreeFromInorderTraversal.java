 ...
 */
public class _15b_ConstructAllBinaryTreeFromInorderTraversal {
    ...
    public static void main(String args[]) {
        _15b_ConstructAllBinaryTreeFromInorderTraversal ct = new _15b_ConstructAllBinaryTreeFromInorderTraversal();

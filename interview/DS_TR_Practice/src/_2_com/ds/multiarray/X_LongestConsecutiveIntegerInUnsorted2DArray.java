 ...
 */
public class X_LongestConsecutiveIntegerInUnsorted2DArray {
	...
	public static void main(String args[]){
		X_LongestConsecutiveIntegerInUnsorted2DArray lci = new X_LongestConsecutiveIntegerInUnsorted2DArray();
		int input[][] = {{3,2,5},
				         {4,1,4},
						 {5,6,5}};

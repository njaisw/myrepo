...
public class X_Merge2BSTs_IMP_3 {
	static class Node {
		int data;
		Node left, right;
...
//Utility function for inorder traversal of the tree 
	...
	public static void main(String[] args) {
		...
		X_Merge2BSTs_IMP_3 tree1 = new X_Merge2BSTs_IMP_3();
		...
		X_Merge2BSTs_IMP_3 tree2 = new X_Merge2BSTs_IMP_3();
		tree2.root = new Node(80);
		tree2.root.left = new Node(40);
		tree2.root.right = new Node(120);

		X_Merge2BSTs_IMP_3 tree = new X_Merge2BSTs_IMP_3();

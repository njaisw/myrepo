...
public class _08_MinimizeHeights_IMP_2 {
	...
	static int getMinDiff(int arr[], int n, int k) {
		...
		for (int i = 1; i < n - 1; i++) {
			...
			// number. Update small or big using greedy approach (If big - subtract causes
			// smaller diff, update small Else update big)

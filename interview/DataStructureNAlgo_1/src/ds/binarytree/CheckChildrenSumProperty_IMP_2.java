 ...
 */
public class CheckChildrenSumProperty_IMP_2 {
	Node root;
	...
	// returns 1 if children sum property holds for the given node and both children
	...
	public static void main(String[] args) {
		CheckChildrenSumProperty_IMP_2 tree = new CheckChildrenSumProperty_IMP_2();

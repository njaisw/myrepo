 ...
 */
public class X_CountDistictSubstring {
	...
	static class SuffixTrieNode {
		...
		// A recursive function to insert a suffix of the s in subtree rooted with node
	...
	static class Suffix_trie {
		...
		Suffix_trie(String s) {
			...
			// using recursive function insertSuffix() in SuffixTrieNode class
	...
	public static void main(String args[]) {
		String str = "ababa";
		System.out.println("Count of distinct substrings is " + countDistinctSubstring(str));

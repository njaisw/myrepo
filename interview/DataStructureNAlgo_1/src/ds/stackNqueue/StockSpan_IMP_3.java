...
public class StockSpan_IMP_3 {
	// a linear time solution for stock span problem A stack based efficient method
	...
	static void calculateSpan(int price[], int n, int S[]) {
		...
		for (int i = 1; i < n; i++) {
			...
			// it, i.e., price[0], price[1],..price[i-1]. Else price[i] is greater than
